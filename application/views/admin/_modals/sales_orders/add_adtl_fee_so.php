				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="form-group col-sm-12 col-md-9 mx-auto">
							...
							<input type="number" class="form-control" name="qty" min="0" placeholder="---">
						</div>
						<div class="form-group col-sm-12 col-md-9 mx-auto">
							<label class="input-label">UNIT PRICE</label>
							<input type="number" class="form-control" name="unit-price" min="0" placeholder="0.00" step="0.000001" required>
						</div>
					</div>
				</div>
