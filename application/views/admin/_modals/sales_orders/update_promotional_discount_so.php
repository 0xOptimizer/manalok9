...
<div class="modal fade" id="SOPromoDiscount" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-md" role="document">
		<form id="formSOPromoDiscount" action="<?php echo base_url() . 'FORM_updateSOPromoDiscount';?>" method="POST">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group col-sm-12 col-md-9 mx-auto">
						...
						<input id="sales_order_promotional_discount" type="number" min="0" class="form-control" name="promotional_discount" placeholder="*" required>
					</div>
				</div>
