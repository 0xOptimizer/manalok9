<?php if (!$this->session->userdata('UserRestrictions')['purchase_orders_bill_creation']) return; ?>
		...
		<form id="formAddPOBill" action="<?php echo base_url() . 'FORM_addPOBill';?>" method="POST">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" style="margin: 0 auto;"><i class="bi bi-cash" style="font-size: 24px;"></i> PO Bills</h4>
				</div>
