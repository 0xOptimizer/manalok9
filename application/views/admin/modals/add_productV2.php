			...
			<div class="modal-content">
				...
				<div class="modal-body m-4">
					<div class="form-row d-flex flex-wrap">
						...
						<div class="form-group col-12 col-sm-12 col-md m-1">
					...
					<div class="form-row d-flex flex-wrap">
						<div class="form-group col-12 col-sm-12 col-md-8 m-1">
					...
					<div class="form-row d-flex flex-wrap mt-4">
						<div class="form-group col-12 m-2">
							<h5 style="color: #C6C6C6;">
								Details
							</h5>
					...
					<div class="form-row d-flex flex-wrap">
						<div class="form-group col-12 col-sm-12 col-md-6 m-1">
