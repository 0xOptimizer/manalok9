<div class="modal fade" id="release_manually" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="feedback-form modal-footer">
				<button id="release_submit_manual" type="button" class="btn btn-success"><i class="bi bi-cart-check"></i> Add to Cart</button>
			</div>
		</div>
	</div>
</div>