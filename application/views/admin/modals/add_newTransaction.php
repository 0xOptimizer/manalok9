<div class="modal fade" id="new_transactionModal" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-sm" role="document">
		<form action="<?php echo base_url() . 'FORM_NewTransaction';?>" method="POST" enctype="multipart/form-data">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12">
						<div class="row">
							<div class="col-sm-12">
								<label style="font-size: 12px;">FOR PRODUCT CODE</label>
								<p id="transaction-codes" style="color: #BCA215;">
									
								</p>
								<input id="transaction-code" type="hidden" name="transaction-code" readonly>
							</div>
