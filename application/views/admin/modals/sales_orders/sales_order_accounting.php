<?php if (!$this->session->userdata('UserRestrictions')['sales_orders_accounting']) return; ?>
									...
									foreach ($getOrderJournals->result_array() as $row): ?>
										<tr class="tr_class_modal" data-id="<?=$row['ID']?>">
											...
											<td class="text-center">
												...
												<?php if ($this->session->userdata('UserRestrictions')['journal_transactions_delete'] || $this->session->userdata('UserRestrictions')['sales_orders_accounting']): ?>
